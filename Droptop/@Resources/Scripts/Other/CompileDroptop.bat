...
%4 !WriteKeyValue Variables AutohideDelayNum 4 %5Droptop\@Resources\GlobalVar\UserSettings.inc"
...
REM xcopy /y /c /h /e /i %5Droptop" "%USERPROFILE%\OneDrive\Droptop\Archive\%2\Droptop"
REM xcopy /y /c /h /e /i %5Droptop Folders" "%USERPROFILE%\OneDrive\Droptop\Archive\%2\Droptop Folders"
