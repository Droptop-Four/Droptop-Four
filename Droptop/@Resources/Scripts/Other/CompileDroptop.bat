...
%4 !WriteKeyValue Variables DroptopSleepMode 1 %5Droptop\@Resources\GlobalVar\UserSettings.inc"
%4 !WriteKeyValue Variables DroptopSleepMinutes 5 %5Droptop\@Resources\GlobalVar\UserSettings.inc"
