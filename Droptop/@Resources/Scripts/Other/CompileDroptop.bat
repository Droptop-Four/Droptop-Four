...
%4 !WriteKeyValue Variables CustomAppID6 "Gsuite-Cariboudjan" %5Droptop\@Resources\GlobalVar\UserSettings.inc"
...
%4 !WriteKeyValue Variables Gsuite-Cariboudjan 6 %5Droptop\@Resources\GlobalVar\UserSettings.inc"
