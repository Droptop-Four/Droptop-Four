...
%4 !WriteKeyValue Variables AutohideTriggerType 2 %5Droptop\@Resources\GlobalVar\UserSettings.inc"
...
%4 !WriteKeyValue Variables SideAppPosCustomApp10 4 %5Droptop\@Resources\GlobalVar\TopBarPos.inc"
