...
[System.Diagnostics.Process]::Start($startInfo) | Out-Null
	...
	Remove-Item -Path "$skinsPath\Droptop Community Apps" -Recurse
	Remove-Item -Path "$skinsPath\Droptop Folders" -Recurse
	Remove-Item -Path "$skinsPath\Droptop" -Recurse

	Remove-Item -Path "$appData\Rainmeter\Layouts\Droptop" -Recurse
